  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Subscribe to our newsletter to receive updates about new features, design inspiration, creator spotlights, and exclusive offers for the JUTE Fashion community.
      </p>
      <div>
        <input
          type="text"
          ...
          className="text-body-color focus:border-primary dark:text-body-color-dark dark:shadow-two dark:focus:border-primary mb-4 w-full rounded-xs border border-gray-300 bg-[#f8f8f8] px-6 py-3 text-base outline-hidden dark:border-gray-700 dark:bg-black dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg px-9 py-4 text-base font-medium text-white duration-300"
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#FF6B35" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
